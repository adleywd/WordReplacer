...
public class GenericExtensionsTests
{
    ...
    {
        private class CombinationsTestData :
            TheoryData<List<KeyValuePair<string, List<string>>>, List<Dictionary<string, string>>>
        {
        ...
        private void GetCombinations_WithValidNodeList_ShouldReturnListWithAllPossibleCombinationsInDict(
            List<KeyValuePair<string, List<string>>> inputs, List<Dictionary<string, string>> expectedListResult)
        {
            // Arrange
